...
export default function Product2(): JSX.Element {
  return (
    <>
      <Helmet>
        <title>Agri-Hawk Drone 100 | Advanced Agricultural Spraying Drone | Hawk Aero System</title>
        <meta name="description" content="Agri-Hawk Drone 1000 is a 100L agricultural precision spraying drone delivering high efficiency crop spraying, dual pump system, modular sensors and radar-based flight safety." />
      ...
      <section className="relative h-[90vh] mt-[90px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-200 text-base md:text-lg max-w-xl mx-auto">
            A powerful 100L agricultural drone built for precision spraying.
          </p>
        </motion.div>
      </section>
